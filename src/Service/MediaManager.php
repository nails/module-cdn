...
use Nails\Cdn\Admin\Controller\MediaManagerV1;
use Nails\Cdn\Admin\Controller\MediaManagerV2;
...
class MediaManager
{
    ...
    public function getUrl(array $query = [], string $path = '', ?int $version = null): string
    {
        ...
        $managerUrl = match ($version) {
            Constants::MEDIA_MANAGER_V1 => MediaManagerV1::url(),
            Constants::MEDIA_MANAGER_V2 => MediaManagerV2::url(),
            default => null,
        };

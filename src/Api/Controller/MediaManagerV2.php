...
class MediaManagerV2 extends Api\Controller\Base
{
    ...
    {
        return parent::isAuthenticated($sHttpMethod, $sMethod) && userHasPermission(Permission\Object\Browse::class);
    }
    ...
    public function postReplace(): ApiResponse
    {
        ...
        if (!userHasPermission(Permission\Object\Replace::class)) {
            throw new Api\Exception\ApiException(
                'You do not have permission to access this resource',
                $oHttpCodes::STATUS_UNAUTHORIZED
            );
    ...
    public function postMove(): ApiResponse
    {
        ...
        if (!userHasPermission(Permission\Object\Move::class)) {
            throw new Api\Exception\ApiException(
                'You do not have permission to access this resource',
                $oHttpCodes::STATUS_UNAUTHORIZED
            );
    ...
    public function postCopy(): ApiResponse
    {
        ...
        if (!userHasPermission(Permission\Object\Copy::class)) {
            throw new Api\Exception\ApiException(
                'You do not have permission to access this resource',
                $oHttpCodes::STATUS_UNAUTHORIZED
            );
